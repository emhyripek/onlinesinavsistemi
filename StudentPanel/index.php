    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper" style="background-image: url('../assets/images/background/studentpanel-bg.png'); background-size: cover; background-repeat: no-repeat;">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="home-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div>
                                                        <p class="statistics-title">Toplam Ders Çeşidi</p>
                                                        <h3 class="rate-percentage"><?php echo $count; ?></h3>
                                                    </div>
                                                    <div>
                                                        <p class="statistics-title">Hazırlanan Sınav Sayısı</p>
                                                                    ...
                                                                    <div class="wrapper w-100">
                                                                        <p class="mb-0">
                                                                            <a href="testtable.php"
                                                                               class="fw-bold text-primary">Tüm sınavları
                                                                                gör...
