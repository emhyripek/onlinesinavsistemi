        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            <ul class="navbar-nav">
                <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                    ...
                    <h3 class="welcome-sub-text">Yanlışlar doğruları götürmemektedir. Başarılar Dileriz.</h3>
                </li>
            </ul>
        </div>
    </nav>
        ...
        $(document).ready(function () {
            ...
            function startTimer() {
                timerInterval = setInterval(function () {
                    ...
                    $(".welcome-sub-text").text("Yanlışlar doğruları götürmemektedir. Başarılar Dileriz.");
